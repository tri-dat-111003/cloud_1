...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="<c:url value="/admin/assets/vendor/bootstrap/css/bootstrap.min.css"/>"
          rel="stylesheet">
    <link href="<c:url value="/admin/assets/vendor/bootstrap-icons/bootstrap-icons.css"/>"
          rel="stylesheet">
    <link href="<c:url value="/admin/assets/vendor/boxicons/css/boxicons.min.css"/>" rel="stylesheet">
    <link href="<c:url value="/admin/assets/vendor/quill/quill.snow.css"/>" rel="stylesheet">
    <link href="<c:url value="/admin/assets/vendor/quill/quill.bubble.css"/>" rel="stylesheet">
    <link href="<c:url value="/admin/assets/vendor/remixicon/remixicon.css"/>" rel="stylesheet">
    <link href="<c:url value="/admin/assets/vendor/simple-datatables/style.css"/>" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="<c:url value="/admin/assets/css/style.css"/>" rel="stylesheet">

    <!-- Logo -->
    <link rel="shortcut icon" href="<c:url value="/store/icon/paper-plane.ico"/>">
